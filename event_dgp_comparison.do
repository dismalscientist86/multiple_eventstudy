...
foreach event_dgp in lognormal_gap_outside_2events random_assignment_nomax random_assignment_2events next_probability_2events lognormal_gap_outside_2events lognormal_gap_2events fixed_period_2events tightgap_2events {
...
graph export graphs/${eventspec}.eps, replace
local graphlist `graphlist' graphs/${eventspec}.eps



}
instanttex using graphs/event_dgp.tex, fig(`graphlist') replace
