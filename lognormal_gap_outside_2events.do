global eventdesc "Two events, second is outside the event window of the first"
local eventgap int(rand2) + 48
...
by location: egen event_r1 = max($panelsize+int(rand1*($maxtime-$panelsize*4))) 
